document.addEventListener('DOMContentLoaded', () => {
    ...
    const textToType = "Criando experiências web que marcam.";
    ...
    document.querySelectorAll('.project-card, .sidebar-project-btn').forEach(card => {
        card.addEventListener('click', () => {
            ...
            if (card.dataset.link && card.dataset.link.trim() !== '') {
                ...
                overlayAccess.style.display = 'inline-block';
            } else {
                overlayAccess.href = '#';
                overlayAccess.style.display = 'none';
            }
